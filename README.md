...
1. **2 steps Rectification:**
   ...
   Results are good.
    ...
    <figure style="width: 32%;">
        <img src="HW2/pictures/tile.jpg" alt="Image 1" style="width: 100%;">
        <figcaption>Original Image</figcaption>
    </figure>
    <figure style="width: 32%;">
        <img src="HW2/pictures/tile_affine_rect.jpg" alt="Image 2" style="width: 100%;">
        <figcaption>Affine Rectification</figcaption>
    </figure>
    <figure style="width: 32%;">
        <img src="HW2/pictures/tile_metric_rect.jpg" alt="Image 3" style="width: 100%;">
...
2. **1 step Rectification:**
   ...
   Result not as good.
    ...
    <figure>
        <img src="HW2/pictures/tile_5_pairs_rect.jpg" alt="1 step Rectification" style="width: 100%;">
